...
def some(sentences):
    ...
    [d,Lambdat]=lambdatri(Countbitrain,Countunitrain,Countritrain)
    print(perplex)
    return [d,Lambdat,Countbitrain,Countunitrain,Countritrain,Bipr,unitest,bitest,tritest]
    
def perlex(d,Lambdat,Countbitrain,Countunitrain,Countritrain,Bipr,unitest,bitest,tritest):
